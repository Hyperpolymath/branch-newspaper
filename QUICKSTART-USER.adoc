= Branch Newspaper — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/branch-newspaper
cd branch-newspaper
...
* https://github.com/hyperpolymath/branch-newspaper/issues — report bugs
