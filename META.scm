...
(define-module (branch-newspaper meta)
...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "A Phoenix LiveView application for managing and distributing meeting minutes with IPFS integration for decentralized content storage.")
...
(cross-platform-status
  ...
  (gitlab-url "https://gitlab.com/hyperpolymath/branch-newspaper")
  (instructions
